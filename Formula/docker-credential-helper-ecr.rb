class DockerCredentialHelperEcr < Formula
  ...
  bottle do
    root_url "https://github.com/gromgit/homebrew-core-aarch64_linux/releases/download/docker-credential-helper-ecr"
    sha256 cellar: :any_skip_relocation, aarch64_linux: "a7e8114c1d6f3e06487d88fdf2502860361bac72f4b26a234474b62803bfa262"
  end
