class Snort < Formula
  ...
  url "https://github.com/snort3/snort3/archive/3.1.39.0.tar.gz"
  mirror "https://fossies.org/linux/misc/snort3-3.1.39.0.tar.gz"
  sha256 "2b2ff78b46302296f9cf9104a9e95df10f95dbc2c6b62ddb668666bae846426b"
