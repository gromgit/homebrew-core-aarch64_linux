class Nuget < Formula
  ...
  url "https://dist.nuget.org/win-x86-commandline/v6.2.0/nuget.exe" # make sure libexec.install below matches case
  sha256 "c89875d937b7faff3ac024c3ceeceaaecbd786c47b33c09dd4129275a405594b"
  license "MIT"
