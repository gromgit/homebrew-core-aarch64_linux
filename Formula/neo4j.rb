class Neo4j < Formula
  ...
  url "https://neo4j.com/artifact.php?name=neo4j-community-4.4.5-unix.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "98b2afdad01e9f41ab0c9a769a029490613ddaa0c5fb8353349553a16d6a886f"
  end
