class Neo4j < Formula
  ...
  url "https://neo4j.com/artifact.php?name=neo4j-community-4.4.6-unix.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "8e2bcc698ab8811bdebe1eca1411ba92a17481e72b20987ed60d654f1fa1f00e"
  end
