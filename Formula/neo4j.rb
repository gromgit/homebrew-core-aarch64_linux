class Neo4j < Formula
  ...
  url "https://neo4j.com/artifact.php?name=neo4j-community-4.3.6-unix.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "830eb3d735e72b9ae4c535498a0e0a0a5a48b88211b8c16602c519b3cecd738e"
  end
