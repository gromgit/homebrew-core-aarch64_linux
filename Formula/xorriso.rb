class Xorriso < Formula
  ...
  url "https://ftpmirror.gnu.org/xorriso/xorriso-1.4.2.tar.gz"
  ...
  # See https://lists.gnu.org/archive/html/bug-xorriso/2016-05/msg00001.html
  patch :p0 do
    url "https://bazaar.launchpad.net/~libburnia-team/libisofs/scdbackup/diff/1319"
