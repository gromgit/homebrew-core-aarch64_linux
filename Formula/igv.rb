class Igv < Formula
  ...
  url "https://data.broadinstitute.org/igv/projects/downloads/2.12/IGV_2.12.3.zip"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "c54796d261bf840af369acf83a00830a72cac34cb3b1435fa86c45a4e5fcfd58"
  end
